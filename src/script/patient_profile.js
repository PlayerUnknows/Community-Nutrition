        ...
        if (response.status === "success" && response.data) {
          ...
          var detailsHtml = `
            ...
            patient.patient_lname
                                    ...
                                    <p><strong>Food Restrictions:</strong> ${
                                      patient.patient_food_restrictions ||
                                      "None"
                                    }</p>
                                    <p><strong>Medical History:</strong> ${
                                      patient.patient_medical_history || "None"
                                    }</p>
                                    <p><strong>Dietary Record:</strong> ${
                                      patient.dietary_consumption_record ||
                                      "None"
                                    }</p>
                                </div>
                            </div>
