    ...
    <div class="row mb-3">
        <div class="col-12">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item bmi-export" href="#" data-export="excel" data-type="bmi-category">BMI Category Distribution</a></li>
                    <li><a class="dropdown-item bmi-export" href="#" data-export="excel" data-type="bmi-table">BMI History</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<link rel="stylesheet" href="../../assets/css/bmi_statistics.css">
