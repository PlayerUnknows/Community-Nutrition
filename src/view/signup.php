        ...
        <div class="form-group mb-4">
            <div class="form-check">
                ...
                <label class="form-check-label" for="privacyAgreement">
                    ...
                    <a href="#" id="privacyModalLink">Data Privacy Policy</a>
                </label>
                <div class="invalid-feedback">
                    <i class="fas fa-exclamation-circle me-1"></i>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (credentialsModalEl) {
            credentialsModal = new bootstrap.Modal(credentialsModalEl, {
                backdrop: 'static',
                keyboard: false
            });
        }
        ...
        // Add click event handler for privacy modal link
        const privacyModalLink = document.getElementById('privacyModalLink');
        if (privacyModalLink && privacyModal) {
            privacyModalLink.addEventListener('click', function(e) {
                e.preventDefault();
                try {
                    privacyModal.show();
                } catch (error) {
                    console.error('Error showing privacy modal:', error);
                    // Fallback: try to show modal using Bootstrap's data attributes
                    privacyModalEl.setAttribute('data-bs-toggle', 'modal');
                    privacyModalEl.setAttribute('data-bs-target', '#privacyModal');
                    const fallbackModal = new bootstrap.Modal(privacyModalEl);
                    fallbackModal.show();
                }
            });
        }
